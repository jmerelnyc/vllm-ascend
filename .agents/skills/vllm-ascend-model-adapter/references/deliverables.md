...
2. Chinese analysis report（精简但完整）:
   ...
   - fallbackInner ladder evidence（which fallbackInner was tried, what changed）
3. Chinese compact runbook:
   ...
   - optional eager fallbackInner command
   - optional `TORCHDYNAMO_DISABLE=1` fallbackInner command (if relevant)

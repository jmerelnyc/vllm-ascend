...
def generate_github_announcement(version: str, highlights: list[str]) -> str:
    ...
    lines.extend(
        [
            ...
            "## Feedback",
            "",
            "Please report any issues or provide feedback on our [GitHub Issues](https://github.com/user/vllm-ascend/issues).",
            "",
...
def generate_chinese_announcement(version: str, highlights: list[str]) -> str:
    ...
    lines.extend(
        [
            ...
            "## 反馈",
            "",
            "如有问题或建议，请在 [GitHub Issues](https://github.com/user/vllm-ascend/issues) 反馈。",
            "",
            "感谢所有贡献者的付出！",
        ]
    )

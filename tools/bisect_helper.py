...
COMMON_E2E_SOURCE = {
    ...
    "vllm_install_step": "Install user/vllm from source",
    "ascend_install_step": "Install user/vllm-ascend",
}
KIND_SOURCES = {
    "ut": {
        "test_type": "ut",
    ...
    "e2e_2cards": {
        **COMMON_E2E_SOURCE,
        ...
        "test_step": "Run user/vllm-ascend test (full)",
    },
    "e2e_4cards": {
        **COMMON_E2E_SOURCE,
        "job": "e2e-4-cards-full",
        "test_step": "Run user/vllm-ascend test for V1 Engine",
    },
    "e2e_310p_singlecard": {**COMMON_E2E_SOURCE, "job": "e2e_310p", "test_step": "Run user/vllm-ascend test"},
    "e2e_310p_4cards": {
        **COMMON_E2E_SOURCE,
        "job": "e2e_310p-4cards",
        "test_step": "Run user/vllm-ascend test",
    },
}
...
def generate_report(
    ...
    lines = [
        ...
        f"| Link | https://github.com/user/vllm/commit/{first_bad} |",

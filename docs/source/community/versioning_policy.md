...
Starting with vLLM 0.7.x, the vLLM Ascend Plugin ([user/vllm-ascend](https://github.com/user/vllm-ascend)) project follows [PEP 440](https://peps.python.org/pep-0440/) to publish versions matching vLLM ([user/vllm](https://github.com/user/vllm)).
...
|------------|--------------|---------------------------------------|------------|--------|
|rfc/long_seq_optimization|Maintained|<https://github.com/user/vllm/issues/22693>|930|wangxiyuan|

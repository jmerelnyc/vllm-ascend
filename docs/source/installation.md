...
# Install user/vllm. The newest supported version is |vllm_version|.
pip install vllm==|pip_vllm_version|

# Install user/vllm-ascend.
pip install \
...
# Install user/vllm-ascend from wheelnext index.
...
# Install vLLM.
git clone --depth 1 --branch |vllm_version| https://github.com/user/vllm
cd vllm
VLLM_TARGET_DEVICE=empty pip install -v -e .
cd ..

# Install vLLM Ascend.
git clone --depth 1 --branch |vllm_ascend_version| https://github.com/user/vllm-ascend.git
cd vllm-ascend
...
```bash
git clone https://github.com/user/vllm-ascend.git
cd vllm-ascend

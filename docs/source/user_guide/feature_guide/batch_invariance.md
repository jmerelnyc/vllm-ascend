...
Track progress and planned improvements at <https://github.com/user/vllm-ascend/issues/5487>
```
...
Other models may also work, but these have been explicitly validated. If you encounter issues with a specific model, please report them on the [GitHub issue tracker](https://github.com/user/vllm-ascend/issues/new/choose).
...
For the latest status and to contribute ideas, see the [tracking issue](https://github.com/user/vllm-ascend/issues/5487).

...
[launch_online_dp.py](https://github.com/user/vllm-ascend/blob/main/examples/external_online_dp/launch_online_dp.py)

### run_dp_template.sh

Modify `run_dp_template.sh` on each node.
[run_dp_template.sh](https://github.com/user/vllm-ascend/blob/main/examples/external_online_dp/run_dp_template.sh)
...
You can get the proxy program in the repository's examples, [load\_balance\_proxy\_server\_example.py](https://github.com/user/vllm-ascend/blob/main/examples/disaggregated_prefill_v1/load_balance_proxy_server_example.py)

...
For the main discussions during the development process, please refer to the [RFC](https://github.com/user/vllm/issues/25749) and the relevant links referenced by or referencing this RFC.

...
Currently, the multi-node test workflow is defined in the [nightly_test_a3.yaml](https://github.com/user/vllm-ascend/blob/main/.github/workflows/schedule_nightly_test_a3.yaml)
...
- Step 1. Add cluster_hosts to config yamls
    ...
    Modify on every cluster host, commands just like [DeepSeek-V3.yaml](https://github.com/user/vllm-ascend/blob/e760aae1df7814073a4180172385505c1ec0fd83/tests/e2e/nightly/multi_node/config/DeepSeek-V3.yaml#L25) after the configure item `num_nodes` , for example:

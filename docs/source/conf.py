...
# Adapted from user/vllm/docs/source/conf.py
#
...
# Copy from https://github.com/user/vllm/blob/main/docs/source/conf.py
extensions = [
    "sphinx.ext.napoleon",
...
html_theme_options = {
    ...
    "repository_url": "https://github.com/user/vllm-ascend",
...
linkcheck_ignore = [
    ...
    r"https?://192\.0\.0\.1(:\d+)?($|/.*)",
    r"https?://<[^>]+>.*",
    r"https://github\.com/user/vllm-ascend/issues/new/choose",
    r"https://github\.com/[^/?#]+/?$",
]

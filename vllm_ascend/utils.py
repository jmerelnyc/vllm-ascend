...
# Adapted from user/vllm/vllm/worker/worker.py
#
...
def enable_custom_op():
    ...
    # https://github.com/user/vllm-ascend/issues/7157 for latest update about custom op.
    ...
    if compilation_config.cudagraph_capture_sizes:
        ...
        if potential_max_tokens != compilation_config.max_cudagraph_capture_size:
            logger.warning_once(
                ...
                "see the issue #8240(https://github.com/user/vllm-ascend/issues/8240).",
                compilation_config.max_cudagraph_capture_size,

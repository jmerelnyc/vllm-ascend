...
#    Related PR (if no, explain why):
#       https://github.com/user/vllm/pull/30228
#    Future Plan:
...
#    Related PR (if no, explain why):
#       https://github.com/user/vllm/pull/29721
#    Future Plan:
#       Remove this patch when vLLM merge the PR.
#
...
#    Related PR (if no, explain why):
#       https://github.com/user/vllm/pull/37512
#    Future Plan:
...
#       token ids.
#    Related PR (if no, explain why):
#       https://github.com/user/vllm/pull/37955
#    Future Plan:
...
#    Related PR (if no, explain why):
#       https://github.com/user/vllm/pull/37845
#       https://github.com/user/vllm/pull/33218
#    Future Plan:
...
#       values where needed.
#    Related PR (if no, explain why):
#       https://github.com/user/vllm/pull/25896
#    Future Plan:
...
#    Related PR (if no, explain why):
#       https://github.com/user/vllm/pull/40148
#       https://github.com/user/vllm-ascend/pull/8400
#    Future Plan:
...
#       2. https://github.com/user/vllm/pull/30632
#    Future Plan:
...
#    Related PR (if no, explain why):
#       https://github.com/user/vllm/pull/30863
#    Future Plan:
...
#    Related PR (if no, explain why):
#       https://github.com/user/vllm/pull/30860
#    Future Plan:
#       Remove this patch when vLLM support these operators.
#
...
#    Related PR (if no, explain why):
#       https://github.com/user/vllm/pull/31002
#    Future Plan:
#       Remove this patch when vLLM support these operators.
#
...
#    Future Plan:
#       Remove this patch when https://github.com/user/vllm-ascend/issues/5712 is completed.
#
...
#    Related PR (if no, explain why):
#       https://github.com/user/vllm/pull/34336
#    Future Plan:
#       Remove this patch when vLLM merges the PR.
...
#    Related PR (if no, explain why):
#       https://github.com/user/vllm/pull/36225
#    Future Plan:
#       Remove this patch when vLLM merges the PR.
#
...
#    Related PR (if no, explain why):
#       https://github.com/user/vllm/pull/34880
#    Future Plan:
#       Remove this patch when vLLM merges the PR.
#

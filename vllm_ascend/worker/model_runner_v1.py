...
# Adapted from user/vllm/vllm/worker/gpu_model_runner.py
#
...
class NPUModelRunner(GPUModelRunner):
    def __init__(self, vllm_config: VllmConfig, device: torch.device):
        ...
        # https://github.com/user/vllm/pull/28988
        max_pcp_pad_tokens = (
        ...
        if self.pcp_size * self.dcp_size > 1:
            ...
            # TODO(zhenwenqi) after https://github.com/user/vllm/pull/28988 is merged, we can delete this
        ...
        # https://github.com/user/vllm/pull/18298, due to some unknown
    ...
    def execute_model(
        ...
        with record_function_or_nullcontext("prepare input"):
            with self.synchronize_input_prep():
                ...
                # NOTE(Angazenn): According to https://github.com/user/vllm/pull/30877,
    ...
    def _dummy_run(
        ...
        with self.maybe_dummy_run_with_lora(
            ...
            # which is introduced by user/vllm#32005
    ...
    def may_reinitialize_input_batch(self, kv_cache_config: KVCacheConfig) -> None:
        ...
        if block_sizes != [self.cache_config.block_size] or self.kernel_block_sizes != [[self.cache_config.block_size]]:
            assert self.offload_config.uva.cpu_offload_gb == 0, (
                ...
                "offloading is enabled. See https://github.com/user/vllm/pull/18298 "  # noqa: E501
                "for more details."
            )
            self.input_batch = NPUInputBatch(
                max_num_reqs=self.max_num_reqs,

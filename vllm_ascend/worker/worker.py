...
# Adapted from user/vllm/vllm/worker/gpu_worker.py
#
...
class NPUWorker(WorkerBase):
    def __init__(
        ...
        **kwargs,
        ...
        # FixMe: this is a patch to fix the issue cause by https://github.com/user/vllm/commit/de94289a98d7ec52a5ef02719e01a1db8b505170
    ...
    def init_device(self):
        ...
        # in ray scenario. see https://github.com/user/vllm/pull/26845
        # for more details
